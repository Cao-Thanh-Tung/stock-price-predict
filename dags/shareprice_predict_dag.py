...
def craw_stock_price(**kwargs):
    ...
    #     stock_price_df = pd.concat([stock_price_df, stock], ignore_index=True)
    stock_price_df = pd.DataFrame(json_x)
    stock_price_df.to_csv("/home/stock_price.csv", index=None)
    return True
...
def train_model():
    ...
    dataset_train = pd.read_csv('/home/stock_price.csv')
    ...
    regressor.save("/home/stockmodel.h5")
    return True
...
def email():
    ...
    out_csv_file_path = '/home/stock_price.csv'
    import base64
    message = Mail(
        from_email='caothanhtung08082002@gmail.com',
        to_emails='caothanhtung08082002@gmail.com',
        subject='Your file is here!',
        html_content='Dear Customer,<br>Hi, i am Cao Thanh Tung. Your file is in attachment<br>Thank you!'
    )
    ...
    try:
        sg = SendGridAPIClient("SendGrid token id")
...
dag = DAG(
    'tung_dag',
    default_args={
        'email': ['caothanhtung08082002@gmail.com'],
